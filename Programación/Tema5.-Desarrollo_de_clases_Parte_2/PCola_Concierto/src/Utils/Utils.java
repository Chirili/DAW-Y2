...
public class Utils {
    ...
    public static String calcDNI() {
        Scanner sc = new Scanner(System.in);
        int dni;
        do {
            System.out.print("Introduce el numero de DNI, solo el numero: ");
            dni = sc.nextInt();
        } while (true && String.valueOf(dni).length() > 8);
        
        String caracteres = "TRWAGMYFPDXBNJZSQVHLCKE";
        int resto = dni % 23;
        
        return String.valueOf(dni) + caracteres.charAt(resto);
    }
